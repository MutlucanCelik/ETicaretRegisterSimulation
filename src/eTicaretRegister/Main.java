package eTicaretRegister;



import eTicaretRegister.business.concretes.UserManager;
import eTicaretRegister.core.concretes.GoogleUserInformationManagerAdapter;
import eTicaretRegister.dataAccess.concretes.HibernateUserDao;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		manager1.registerWithGoogle(new GoogleUserInformationManagerAdapter()); //Google hesabı ile kayıt işlemi simülasyonu yapıldı
		System.out.println();
